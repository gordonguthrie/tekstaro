...
AWS_ACCESS_KEY_ID=AKIAYH2HBSU5UN6XEZKH
AWS_SECRET_ACCESS_KEY=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
...
DATABASE_URL=postgresql://postgres:peachymotherfucker@tekstaro-db.comthzko7akq.eu-central-1.rds.amazonaws.com/tekstaro-db
PHOENIX_SECRET_KEY_BASE=CDOWQ8D90cDrb+MfhLnbBhkkJb3HdSjtwY15uyptN8lH/4KuR2Y5hfjUWAvByXsi
SESSION_COOKIE_NAME=helen
SESSION_COOKIE_SIGNING_SALT=the_changing_of_the_guard
SESSION_COOKIE_ENCRYPTION_SALT=this_is_it

# Set runtime ENV.
# These are the runtime environment variables.
# Note that HOST needs to be set.
HOST=ec2-3-120-36-199.eu-central-1.compute.amazonaws.com
PORT=80
